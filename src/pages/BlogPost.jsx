            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-md p-6 transition-colors duration-300">
                ...
                <div className="flex space-x-4">
                  <button className="p-2 rounded-full bg-blue-100 text-blue-600 hover:bg-blue-200 dark:bg-blue-900/40 dark:hover:bg-blue-900/60">
                    <FaFacebook size={20} />
                  </button>
                  <button className="p-2 rounded-full bg-sky-100 text-sky-500 hover:bg-sky-200 dark:bg-sky-900/40 dark:hover:bg-sky-900/60">
                    <FaTwitter size={20} />
                  </button>
                  <button className="p-2 rounded-full bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-900/40 dark:hover:bg-blue-900/60">
                    <FaLinkedin size={20} />
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-md p-6 transition-colors duration-300">
                ...
                <div className="flex flex-wrap gap-2">
                  {post.tags.map((tag, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 bg-secondary-100 text-secondary-600 rounded-full text-sm dark:bg-secondary-700 dark:text-secondary-300 transition-colors duration-300"
                    >
                      {tag}
                    </span>
                  ))}
