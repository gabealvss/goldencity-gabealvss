            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <div className="relative">
                  <FiSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-secondary-400 dark:text-secondary-300" />
                  <input
                    type="text"
            ...
            >
              <Link to={`/blog/${post.slug}`}>
                <div className="relative h-48">
                  ...
                  />
                  <div className="absolute top-4 right-4 bg-white dark:bg-secondary-700 px-3 py-1 rounded-full text-sm font-medium text-primary-600 dark:text-primary-400 transition-colors duration-300">
