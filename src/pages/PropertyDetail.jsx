...
function PropertyDetail() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900 transition-colors duration-300">
      {/* Navigation */}
      <div className="bg-white dark:bg-secondary-800 shadow transition-colors duration-300">
        <div className="container py-4">
          <div className="flex items-center space-x-2 text-sm">
            <Link to="/" className="text-secondary-600 hover:text-primary-600 dark:text-secondary-300 dark:hover:text-primary-400">Home</Link>
            <span className="text-secondary-400">/</span>
            <Link to="/properties" className="text-secondary-600 hover:text-primary-600 dark:text-secondary-300 dark:hover:text-primary-400">Properties</Link>
            <span className="text-secondary-400">/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-secondary-800 rounded-lg shadow-md p-6 transition-colors duration-300"
            >
              ...
              <div className="bg-secondary-50 dark:bg-secondary-700 rounded-lg p-6 mb-6 transition-colors duration-300">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="font-mono text-sm dark:text-white">{property.tokenDetails.contractAddress}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-secondary-50 dark:bg-secondary-700 rounded-lg p-6 transition-colors duration-300">
          ...
          >
            ...
            <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-md p-6 transition-colors duration-300">
              ...
              <div className="mb-6">
                ...
                <div className="w-full bg-secondary-100 dark:bg-secondary-700 rounded-full h-2 transition-colors duration-300">
                  <div
                    className="bg-primary-600 dark:bg-primary-500 h-2 rounded-full transition-colors duration-300"
