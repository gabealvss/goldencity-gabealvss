...
function About() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900 transition-colors duration-300">
      {/* Hero Section */}
      <section className="relative bg-secondary-900 dark:bg-secondary-950 text-white py-24 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-secondary-800 rounded-lg p-6 text-center shadow-md transition-colors duration-300"
              >
      ...
      {/* Mission Section */}
      <section className="py-16 bg-white dark:bg-secondary-800 transition-colors duration-300">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-primary-50 dark:bg-primary-900 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4 transition-colors duration-300">
