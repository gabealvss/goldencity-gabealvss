...
function Properties() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900 transition-colors duration-300">
        ...
        <div className="container py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <button
                className={`p-2 rounded-md transition-colors duration-300 ${showFilters ? 'bg-primary-100 text-primary-600 dark:bg-primary-900 dark:text-primary-400' : 'hover:bg-secondary-100 dark:hover:bg-secondary-700 dark:text-secondary-300'}`}
      ...
      {/* Filters */}
      {showFilters && (
        <div className="bg-white dark:bg-secondary-800 shadow-md border-t dark:border-secondary-700 transition-colors duration-300">
          <div className="container py-6">
            ...
            >
              <Link to={`/properties/${property.id}`}>
                <div className="relative h-48">
                  ...
                  />
                  <div className="absolute top-4 right-4 bg-white dark:bg-secondary-700 px-3 py-1 rounded-full text-primary-600 dark:text-primary-400 font-semibold transition-colors duration-300">
                    {property.status}
                  </div>
                </div>
                <div className="p-6">
                  ...
                  {/* Token Details */}
                  <div className="bg-secondary-50 dark:bg-secondary-700 rounded-lg p-3 mb-4 transition-colors duration-300">
                    <div className="flex justify-between text-sm">
