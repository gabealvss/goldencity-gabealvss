    ...
    <div className="space-y-16">
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1580587771525-78b9dba3b914?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80"
            alt="Hero background"
        ...
        <div 
          className="relative container text-center text-white space-y-8 transition-transform duration-300 ease-out"
          style={{
      ...
      {/* How It Works */}
      <section className="bg-secondary-900 dark:bg-secondary-800 text-white py-16 transition-colors duration-300">
          ...
          {featuredProperties.map((property, index) => (
            ...
            >
              <div className="relative h-48">
                ...
                />
                <div className="absolute top-4 right-4 bg-white dark:bg-secondary-800 px-3 py-1 rounded-full text-primary-600 dark:text-primary-400 font-semibold transition-colors duration-300">
                  {property.status}
                </div>
              </div>
              <div className="p-6">
      ...
      <section className="container">
        <div className="bg-primary-600 dark:bg-primary-700 rounded-2xl p-8 md:p-12 text-white text-center transition-colors duration-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/properties"
              className="btn bg-white text-primary-600 hover:bg-primary-50 dark:bg-secondary-100 dark:text-primary-700 dark:hover:bg-secondary-200"
            >
              Browse Properties
            </Link>
            <button
              className="btn bg-primary-700 hover:bg-primary-800 dark:bg-primary-800 dark:hover:bg-primary-900"
            >
      ...
      {/* Blog */}
      <div className="container bg-white dark:bg-secondary-800 py-24 transition-colors duration-300 rounded-none md:rounded-2xl">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            <motion.article
              ...
              className="bg-white dark:bg-secondary-700 rounded-lg shadow-md overflow-hidden transition-colors duration-300"
            >
              <Link to={`/blog/${post.slug}`}>
                <div className="relative h-48">
                  ...
                  />
                  <div className="absolute top-4 right-4 bg-white dark:bg-secondary-800 px-3 py-1 rounded-full text-sm font-medium text-primary-600 dark:text-primary-400 transition-colors duration-300">
                    {categories.find(c => c.id === post.category)?.name}
                  </div>
                </div>
                <div className="p-6">
                  <h2 className="text-xl font-semibold mb-3 hover:text-primary-600 dark:hover:text-primary-400 dark:text-white transition-colors">
                    {post.title}
                  </h2>
      ...
      {/* Discord CTA */}
      <section className="py-12 bg-primary-900 dark:bg-primary-950 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
              ...
              <dl className="mt-8 space-y-6">
                <div className="flex">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-md bg-primary-700 dark:bg-primary-800 text-white">
                  ...
                  <div className="ml-4">
                    ...
                    <dd className="mt-2 text-base text-primary-100 dark:text-primary-200">
            ...
            <div className="mt-12 lg:mt-0 flex justify-center">
              <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-xl p-8 max-w-sm w-full transition-colors duration-300">
